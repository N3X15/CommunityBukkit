...
public abstract class Event implements Serializable {
    ...
    public enum Category {
        ...
        MISCELLANEOUS,
        /**
         * Biome-related crap (CommunityCraftBukkit)
         */
        BIOME;
    }
    ...
    public enum Type {
        ...
        /**
         * Called before a player gets a velocity vector sent, which will instruct him to get "pushed" into a specific direction, e.g. after an explosion
         * 
        ...
        /**
         * Called when a block is undergoing a universe physics check on whether it can be built
         * <p />
        ...
        /**
         * Called when a block of water or lava attempts to flow into another block
         * 
         * @see org.bukkit.event.block.BlockFromToEvent
         */
        BLOCK_FROMTO(Category.BLOCK, BlockFromToEvent.class),
        /**
         * Called when a block is being set on fire from another block, such as an adjacent block of fire attempting to set fire to wood
         * 
         ...
         * <p />
         * A physics check is commonly called when an adjacent block changes type
         * 
        ...
        /**
         * Called when a block changes redstone current. Only triggered on blocks that are actually capable of transmitting or carrying a redstone current
         * 
         ...
         * <p />
         * If a new chunk is being generated for loading, it will call Type.CHUNK_GENERATION and then Type.CHUNK_LOADED upon completion
         * 
        ...
        /**
         * Called when a creature, either hostile or neutral, attempts to spawn in the world "naturally"
         * 
         ...
         * <p />
         * Canceling the event negates the entity's decision to explode. For EntityCreeper, this resets the fuse but does not kill the Entity. For EntityFireball and EntityTNTPrimed....?
         * 
        ...
        /**
         * Called when an entity interacts with a block This event specifically excludes player entities
         * 
        ...
        BIOME_CLIMATE(Category.BIOME, BiomeClimateEvent.class),
        BIOME_GENERATE(Category.BIOME, BiomesInChunkEvent.class),
        /**
